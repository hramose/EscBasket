    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">{{ $club->name }}</a>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 portfolio-item">
                    ...
                    <a href="#portfolioModal{{$key}}" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="assets/img/portfolio/{{$category->principal_image}}.png" class="img-responsive" alt="">
                    </a>
                </div>
                @endforeach
        ...
        <div class="container">
            ...
            <div class="row" style="text-align:center;">
                <div class="col-lg-4 col-lg-offset-2">
                    <h3>Misión</h3>
                    <p>{{ $club_info->mission }}</p>
                </div>
                <div class="col-lg-4">
                    <h3>Visión</h3>
                    <p>{{ $club_info->vision }}</p>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <hr class="star-primary">
                            <img src="assets/img/portfolio/{{ $category->principal_image }}.png" class="img-responsive img-centered" alt="">
